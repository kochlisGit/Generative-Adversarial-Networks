...
def build_generator(random_normal_noise_size):
    ...
    generator.add(keras.layers.Dense(units=64, activation='selu', input_shape=[random_normal_noise_size]))
    generator.add(keras.layers.Dense(units=128, activation='selu'))
    generator.add(keras.layers.Dense(units=784, activation='sigmoid'))
    generator.add(keras.layers.Reshape(target_shape=(28, 28)))
    return generator
...
def build_discriminator():
    ...
    discriminator.add(keras.layers.Dense(units=128, activation='selu'))
    discriminator.add(keras.layers.Dense(units=64, activation='selu'))
